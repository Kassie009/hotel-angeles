        ...
        <div className="bg-white rounded-2xl shadow-md p-8">
          ...
          <div className="space-y-6 text-cafe-100">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-cafe-100">No almacenamos información de tarjetas de crédito/débito, ya que los pagos se realizan mediante transferencia bancaria.</p>
            </div>
            ...
            <div>
              <h2 className="text-xl font-bold text-cafe-900 mb-3">5. Seguridad de los datos</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-cafe-900 mb-3">6. Derechos ARCO</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-cafe-900 mb-3">7. Cambios al aviso de privacidad</h2>
