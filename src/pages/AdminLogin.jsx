...
return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-950 via-blue-900 to-blue-700">
            {/* Efectos difuminados de fondo */}
            <div className="absolute -top-20 -left-20 w-96 h-96 bg-blue-500 rounded-full blur-3xl opacity-40"></div>
