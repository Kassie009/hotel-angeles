    ...
    <div className="min-h-screen bg-beige-50">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-end">
              <button onClick={handleBuscar} className="w-full bg-cafe-200 hover:bg-cafe-100 text-white py-3 rounded-xl flex items-center justify-center gap-2 transition-all duration-300">
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-cafe-900 mb-4">Servicios y Amenidades</h2>
        ...
        <div className="bg-gradient-to-r from-beige-100 to-beige-50 rounded-2xl p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="overflow-hidden rounded-xl h-64 md:h-80">
              <img src={hotelImg} alt="Hotel Ángeles" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </div>
