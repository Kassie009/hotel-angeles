    ...
    <div className="min-h-screen bg-beige-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Términos y Condiciones</h1>
          ...
          <div className="space-y-6 text-gray-700">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">2. Reservaciones</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">3. Política de Cancelación</h2>
              ...
              <p className="mt-2">Las cancelaciones realizadas con  <strong>48 horas o más de anticipación a la fecha de llegada</strong> tendrán derecho a un reembolso del 100% del monto pagado.</p>
              <p className="mt-2">Las cancelaciones realizadas con <strong>más de 24 y menos de 48 horas de anticipación</strong> tendrán derecho a un reembolso del 50% del monto pagado.</p>
              <p className="mt-2">Las cancelaciones realizadas con <strong>24 horas o menos de anticipación, incluyendo el mismo día de llegada</strong>, no serán reembolsables.</p>
            </div>
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">4. Check-in / Check-out</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">5. Mascotas</h2>
              ...
              <p>Los pagos por mascota se realizan en recepción.</p>
              </ul>
            </div>
            
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">6. Responsabilidad del huésped</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">7. Pago</h2>
